...
#(you could see in the code that x represents one j-pair solution and 
# y represents one (i - j - 1) pair solution, 
...
if __name__=="__main__":
    print(Solution().generateParenthesis2(1))
    print(Solution().generateParenthesis2(2))
